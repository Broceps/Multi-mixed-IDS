...
"""
Clean data for the spoofing dataset by:
...
df = pd.read_csv("../Data/HCRL_Car-Hacking_Dataset/raw_data/gear_dataset.csv", names=fields).astype(str)
...
new_df.to_csv("spoofing_time_between.csv", index=False)
